...
SRC_URI:append = " \
	...
	file://0009-Makefile-Add-flag-for-reprodubility-compiler-flags.patch \
"
...
EXTRA_OEMAKE += "REPRODUCIBLE=y PLATFORM=${RISCV_SBI_PLAT} PLATFORM_RISCV_ISA=rv64imafdc_zicsr_zifencei I=${D}"
